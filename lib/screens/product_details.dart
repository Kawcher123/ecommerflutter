...
class ProductDetailPage extends StatefulWidget {
  static const routeName = "product_detaisl/";
...
class _ProductDetailPageState extends State<ProductDetailPage>
  ...
  Widget _detailWidget(String title, String des, int mprice, int sprice) {
              ...
              children: <Widget>[
                ...
                Container(
                  child: Row(
                    ...
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: <Widget>[
                      TitleText(text: title, fontSize: 25),
                      Column(
        ...
        child: Container(
          ...
          child: Stack(
            children: <Widget>[
              ...
              _detailWidget(product.title, product.description,
                  product.marcketPrice, product.sellingPrice),
            ],
          ),
        ),
      ),
